	...
	'capabilities'       => [
		...
		'shipping' => [
			'methods'             => [
				...
				[
					'id'             => 'ys_ec_ecpay_ship_family_c2c',
					'label'          => '全家超商取貨（C2C 店到店）',
					'provider_label' => 'ECPay',
					'class'          => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayShippingFamilyC2C::class,
					'shipping_type'  => 'cvs',
					'store_selector' => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayStoreSelector::class,
				],
				[
					'id'             => 'ys_ec_ecpay_ship_unimart_c2c',
					'label'          => '7-ELEVEN 超商取貨（C2C 店到店）',
					'provider_label' => 'ECPay',
					'class'          => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayShippingUnimartC2C::class,
					'shipping_type'  => 'cvs',
					'store_selector' => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayStoreSelector::class,
				],
				[
					'id'             => 'ys_ec_ecpay_ship_hilife_c2c',
					'label'          => '萊爾富超商取貨（C2C 店到店）',
					'provider_label' => 'ECPay',
					'class'          => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayShippingHilifeC2C::class,
					'shipping_type'  => 'cvs',
					'store_selector' => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayStoreSelector::class,
				],
				// v0.3.0：低溫
				[
					'id'             => 'ys_ec_ecpay_ship_unimart_freeze',
					'label'          => '7-ELEVEN 冷凍取貨（B2C）',
					'provider_label' => 'ECPay',
					'class'          => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayShippingUnimartFreeze::class,
					'shipping_type'  => 'cvs',
					'store_selector' => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayStoreSelector::class,
				],
				[
					'id'             => 'ys_ec_ecpay_ship_unimart_freeze_c2c',
					'label'          => '7-ELEVEN 冷凍取貨（C2C 店到店）',
					'provider_label' => 'ECPay',
					'class'          => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayShippingUnimartFreezeC2C::class,
					'shipping_type'  => 'cvs',
					'store_selector' => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayStoreSelector::class,
				],
				[
					'id'             => 'ys_ec_ecpay_ship_tcat_chilled',
					'label'          => '黑貓宅配（冷藏）',
					'provider_label' => 'ECPay',
					'class'          => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayShippingTcatChilled::class,
					'shipping_type'  => 'home',
				],
				[
					'id'             => 'ys_ec_ecpay_ship_tcat_frozen',
					'label'          => '黑貓宅配（冷凍）',
					'provider_label' => 'ECPay',
					'class'          => \YangSheep\YSCartEcpay\Shipping\Ecpay\EcpayShippingTcatFrozen::class,
					'shipping_type'  => 'home',
				],
				[
