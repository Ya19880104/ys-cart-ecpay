...
final class EcpayShippingFamilyC2C extends EcpayShipping {
	public function get_id(): string { return 'ys_ec_ecpay_ship_family_c2c'; }
	public function get_title(): string { return '綠界全家超商取貨（C2C 店到店）'; }
	public function get_type(): string { return 'cvs'; }
	public function get_logistics_subtype(): string { return 'FAMIC2C'; }
	protected function settings_key(): string { return 'ship_family_c2c'; }
