...
/**
 * 綠界 7-ELEVEN 超商取貨（C2C 店到店）（v0.3.0）
 *
...
final class EcpayShippingUnimartC2C extends EcpayShipping {
	public function get_id(): string { return 'ys_ec_ecpay_ship_unimart_c2c'; }
	public function get_title(): string { return '綠界 7-ELEVEN 超商取貨（C2C 店到店）'; }
	public function get_type(): string { return 'cvs'; }
	public function get_logistics_subtype(): string { return 'UNIMARTC2C'; }
	protected function settings_key(): string { return 'ship_unimart_c2c'; }
