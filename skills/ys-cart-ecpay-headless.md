...
3. For ECPay CVS shipping, call `/stores/ecpay/map-url` with the selected shipping method ID as `shipping_id`; the bundled SDK helper is `YsCartEcpay.requestStoreMapForm(apiBase, shippingId)`.
